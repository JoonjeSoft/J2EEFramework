...
<nav id="nav" class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        ...
        <div class="navbar-right">
            <shiro:authenticated><a class="btn btn-primary navbar-btn " href="logout"
                                    role="button">退出</a></shiro:authenticated>
            <shiro:notAuthenticated><a class="btn btn-primary navbar-btn " href="login"
                                       role="button">登录</a></shiro:notAuthenticated>
        </div>
    </div>
</nav>
<div class="row-fluid">
